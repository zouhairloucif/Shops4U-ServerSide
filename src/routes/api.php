...
Route::group([
    ...
    Route::post('login', 'FrontOffice\AuthController@login');
    Route::post('logout', 'FrontOffice\AuthController@logout');
    Route::post('refresh', 'FrontOffice\AuthController@refresh');
    Route::post('me', 'FrontOffice\AuthController@me');
    Route::post('userOrFail', 'FrontOffice\AuthController@userOrFail');
    Route::post('isValid', 'FrontOffice\AuthController@isValid');
...
Route::group([
    ...
    Route::post('signup', 'FrontOffice\UserController@signup');
    Route::get('show/{id}', 'FrontOffice\UserController@show');
    Route::post('update/{id}', 'FrontOffice\UserController@update');
    Route::delete('delete/{id}', 'FrontOffice\UserController@delete');
});

/*-------  Api Produits  -------*/

Route::group([
    'prefix' => 'front\produit'
], function ($router) {
    Route::get('all', 'FrontOffice\CatalogueController@AllProduits');
    Route::get('show/{id}', 'FrontOffice\CatalogueController@showProduit');
});

/*-------  Api Catalogue  -------*/

Route::group([
    'prefix' => 'front\categorie'
], function ($router) {
    Route::get('all', 'BackOffice\CatalogueController@AllCategory');
    Route::get('show/{id}', 'BackOffice\CatalogueController@showCategory');
    Route::post('store', 'BackOffice\CatalogueController@StoreCategory');
